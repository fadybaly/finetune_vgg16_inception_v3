...
class vgg16:
    def __init__(self, imgs, weights=None, sess=None, hold_prob=None, num_classes=None, device_name='/CPU:0'):
#        with tf.device(device_name):
        self.imgs = imgs
        self.convlayers(device_name)
        self.fc_layers(hold_prob, num_classes, device_name)
#            self.softmax = tf.nn.softmax(self.fc3l)
    ...
    def convlayers(self, device_name):
#        with tf.device(device_name):
        self.parameters = []
    ...
    def fc_layers(self, hold_prob, num_classes, device_name):
#        with tf.device(device_name):
        # fc1
